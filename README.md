...
F.	¿Qué es un Rol?
G.	Es la asignación que se le da a un usuario donde se especifica qué es lo que puede ver dentro de su organización.

H.	¿Qué es un Validation Rule?
...
I.	¿Qué diferencia hay entre una relación Master Detail y Lookup?
...
P.	¿Para qué sirve la funcionalidad Chatter?
